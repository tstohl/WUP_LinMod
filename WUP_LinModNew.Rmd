...
This model is better than the one for GRIP. The Adjusted R-Square is bigger, which means more errors were reduced and that is what makes this a better model.
...
The  line is the prediction interval. 
The prediction interval is predicting where the next point will be. 
The confidence interval is a prediction of where the line goes. The numbers range from -2.13 to 2.43 It is a confidence on the fit of the line.
